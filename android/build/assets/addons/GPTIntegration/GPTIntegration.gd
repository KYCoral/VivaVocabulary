...
var api_key = "sk-proj-kMLvpY7IhccLrdGWarNaT3BlbkFJMGgj8WlL0iY2jMirNdKO"
var max_tokens = 1024
var temperature = 0.5
...
func _enter_tree():
	printt('_enter_tree')
	chat_dock = preload("res://chatroom.tscn").instantiate()
...
func on_show_settings():
	settings_menu = preload("res://SettingsWindow.tscn").instantiate()
...
func set_settings(api_key, maxtokens, temp, engine):
	...
	if engine == "gpt-4":
		@warning_ignore("standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression")
		id == 0
	elif engine == "gpt-3.5-turbo":
		@warning_ignore("standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression", "standalone_expression")
		id == 1
...
func add_to_chat(text):
	var chat_bubble = preload("res://ChatBubble.tscn").instantiate()
